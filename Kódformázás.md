...
A [master repó](https://github.com/SzFMV2018-Osz/AutomatedCar) össze lett drótozva a [CodaFactorral](https://www.codefactor.io/repository/github/szfmv2018-tavasz/automatedcar) és folyamatosan méri a kód minőségét, valamint egy A-tól F-ig tartó skálán [osztályozza](https://support.codefactor.io/i14-glossary) is (ahol az A a legjobb).